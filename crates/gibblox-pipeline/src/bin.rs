...
use crate::{
    PipelineSource, PipelineSourceAndroidSparseImgSource, PipelineSourceCasync,
    ...
    fn from(source: PipelineSource) -> Self {
        match source {
            ...
            PipelineSource::AndroidSparseImg(PipelineSourceAndroidSparseImgSource {
                ...
                source: Box::new(PipelineSourceBin::from(*android_sparseimg)),
            },
        ...
        match source {
            ...
            PipelineSourceBin::AndroidSparseImg { source } => {
                Self::AndroidSparseImg(PipelineSourceAndroidSparseImgSource {
                    android_sparseimg: Box::new(PipelineSource::from(*source)),
                })
            }
